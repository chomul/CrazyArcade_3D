...
- [x] 리슨/데디 + 클라 2: 원격 화면에서 8종 메시가 전부 같은 자리·같은 방향인가 (③의 실전 확인)
      — **2026-08-15 사용자 멀티 실전 확인 완료**
- [x] 상한 상태 설치 연타 시 몽타주·설치음이 완전히 침묵하는가 (②) — 〃
- [x] 8종 각각 죽는 순간부터 사라질 때까지 Die 가 끝까지 재생되는가 (①) — 〃
